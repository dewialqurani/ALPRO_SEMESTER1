print('=====  MODUL 7 ALGORITMA PEMROGRAMAN  =====')
print('=====  NOMOR 1 TENTANG LIST 2D  =====')
print('')
def createMat2D(x,y):
    a = [[] for i in range (x)]
    for i in range (x):
        for j in range (y):
            a[i].append(int(input('Matrix [{}, {}] = '.format(i,j))))
    return a
